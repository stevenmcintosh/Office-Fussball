                ...
                <tbody>
                    <?php foreach ($leagueFixtures as $fixture) { ?>
                        ...
                        <tr>
                            ...
                            <td><input type="text" size="2" maxlength="2" name="resultHome[<?php echo $fixture->fixtureId; ?>]"> -
                                <input type="text" size="2" maxlength="2" name="resultAway[<?php echo $fixture->fixtureId; ?>]"></td>
                            <td><input type="radio" name="fixId" value="<?php echo $fixture->fixtureId; ?>"/>&nbsp;<input type="submit" name="submit" value="Submit" class="btn btn-success"/>
                                </td>
                        </tr>
