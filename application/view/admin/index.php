...
<div class="row">
    <div class="col-md-12">
        <table class="table table-striped table-bordered">
            <tr>
                <td><a href="<?php echo URL; ?>admin/adminSettings">Admin Settings</a></td>
            </tr>
            <tr>
                <td><a href="<?php echo URL; ?>admin/addResult">Add a League Result</a></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><a href="<?php echo URL; ?>admin/databaseBackup">Backup Database</a></td>
            </tr>
            <tr>
