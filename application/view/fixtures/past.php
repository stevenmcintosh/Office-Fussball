                    ...
                    for ($i = 0; $i < $numTeamsInSeason; $i++) {
                        ...
                        for ($j = 0; $j <= $numTeamsInSeason - 1; $j++) {
                            ...
                            if ($teamsInSeason[$i]->teamId == $teamsInSeason[$j]->teamId) {
                                ...
                                $fixture = $leagueFixturesModel->getFixtureByHomeTeamIdAndAwayTeamIdAndSeasonIdAndDivisionId($teamsInSeason[$i]->teamId, $teamsInSeason[$j]->teamId, $seasonToView, $divId);
